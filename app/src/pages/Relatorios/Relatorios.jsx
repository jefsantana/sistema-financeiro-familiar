...
export default function Relatorios() {
  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', gap: 'var(--espaco-lg)' }}>
      <Panel icone={TrendingDown} titulo="Gastos por Categoria" subtitulo="histórico completo">
        <GraficoBarras dados={gastosPorCategoria} cor="#EF4444" />
      </Panel>

      <Panel icone={TrendingUp} titulo="Entradas por Categoria" subtitulo="histórico completo">
