...
- "gastei 50 no mercado" (sem dizer como pagou) → tipo null, descricao "Mercado", valor 50, categoria "Alimentação" (mercado não é categoria própria), faltando: ["forma_pagamento"], pergunta: "Foi no cartão de crédito, no vale-alimentação (Ticket) ou saiu direto da conta?" (não dá pra saber se afeta o saldo da conta, a fatura do cartão ou o Ticket sem essa informação — mas descricao, valor e categoria já são conhecidos pela mensagem e NÃO ficam null só porque falta a forma de pagamento; se ficarem null aqui, essa informação se perde e não tem como ser recuperada quando a pessoa responder só "pix"/"cartão"/etc, porque a resposta a essa pergunta não repete o resto do lançamento).
